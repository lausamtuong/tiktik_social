...
const Upload = () => {
  ...
  const handlePost = async () => {
    if (caption && topic && video) {
      ...
      await axios.post(`${BASE_}/api/post`, doc);
  ...
  return (
    <>
      <div className="flex w-full mt-[20px] h-full absolute left-0 top-[60px] lg:top-[70px] mb-10 pt-10 lg:pt-16 bg-[#F8F8F8] justify-center">
