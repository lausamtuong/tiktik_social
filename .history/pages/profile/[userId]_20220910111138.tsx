    ...
    <div className="w-full">
      ...
      <div className="">
        <div className="flex gap-10">
          ...
          <div className="flex gap-3">
            <p className="font-bold ">1</p>
            <p className="font-normal text-xl ">following</p>
          </div>
          <div className="flex gap-3">
            <p className="font-bold ">1</p>
            <p className="font-normal ">following</p>
      ...
      <div>
        ...
        >
          <p
            className={`text-xl font-semibold cursor-pointer  mt-2 ml-[90px]`}
            onClick={() => setShowUserVideos(true)}
          >
            Videos
          </p>
          <p
            className={`text-xl flex justify-center items-center font-semibold cursor-pointer  mt-2`}
