...
const Profile = ({ data }: IProps) => {
  ...
  return (
    <div className='w-full'>
      ...
      <div>
        <div className='flex gap-40 mb-10 mt-10 border-b-2 border-gray-200 bg-white w-[45%] pb-[5px] before:content-["*"]
        before:bottom-0 before:absolute before:bg-black before:w-[20px]'>
          <p className={`text-xl font-semibold cursor-pointer ${videos} mt-2 ml-[70px]`} onClick={() => setShowUserVideos(true)}>
            Videos
          </p>
