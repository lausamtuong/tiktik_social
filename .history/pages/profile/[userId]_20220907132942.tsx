...
const Profile = ({ data }: IProps) => {
  ...
  const videos = showUserVideos ? 'before:translate-x-[0%]' : 'before:translate-x-[100%]';
  ...
  return (
    <div className='w-full'>
      ...
      <div>
        ...
        before:bottom-[-2px] ${isHover} ${videos} ${liked} before:duration-200 before:ease-linear before:absolute before:bg-black before:w-[220px] before:h-[3px] before:rounded`}>
          ...
          onMouseEnter={()=>setHover(true)} className={`text-xl font-semibold cursor-pointer  mt-2`} onClick={() => setShowUserVideos(false)}>
            Liked
          </p>
