  ...
  return (
    <div className='w-full'>
      ...
      <div>
        ...
        before:bottom-[-2px] hover:before:translate-x-[100%] duration-300 before:ease-linear before:absolute before:bg-black before:w-[220px] before:h-[3px] before:rounded'>
