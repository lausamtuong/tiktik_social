    ...
    <div className='w-full'>
      <div className='flex gap-6 md:gap-10 mb-4 bg-white w-full'>
        ...
        <div className='flex flex-col justify-start items-start gap-1'>
          <div className='text-8xl md:text-2xl font-bold tracking-wider flex gap-2 items-center justify-center lowercase'>
            <span className='text-8xl'>{user.userName.replace(/\s+/g, '')} </span>
