...
const Upload = () => {
  ...
  const {userProfle}:{userProfile:any}= useAuthStore()
  ...
  return (      
    <div className='flex w-full h-full absolute left-0 top-[60px] lg:top-[70px] mb-10 pt-10 lg:pt-16 bg-[#F8F8F8] justify-center'>
      <div className="bg-white rounded-lg xl:h-[85vh] flex gap-6 flex-wrap items-center justify-center p-14 pt-2">
        <div className="">
          <div className="">
