            ...
            <div className="lg:mt-20 mt-10">
              ...
              <div className=" px-5">
                ...
                <div className="flex text-[14px] text-[#161823bf] mt-[16px] rounded-[2px] border-[1px] border-gray-300">
                  ...
                  <button className='text-black px-[18px] py-[7px] cursor-pointer hover:bg-gray-200 font-bold  whitespace-nowrap' onClick={() =>  window..setData("Text", 'Copy this text to clipboard')}>Copy Link</button>
                </div>
              </div>
              {/* <Comments
                comment={comment}
