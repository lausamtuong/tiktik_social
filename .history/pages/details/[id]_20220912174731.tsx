            ...
            <div className="lg:mt-20 mt-10">
              ...
              <div className=" px-5">
                ...
                <div className="flex text-[14px] text-[#161823bf] mt-[16px] rounded-[2px] border-[1px] border-gray-300">
                  <p className="overflow-hidden text-ellipsis whitespace-nowrap bg-[#1618230f] pt-[7px] pl-[5px] pr-[12">1233333333333333333333333333333333333333333333333333333323123213213</p>
