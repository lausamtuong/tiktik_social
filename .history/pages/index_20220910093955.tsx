    ...
    <>
      ...
      <div className="fixed bottom-4  right-8">
        ...
        <Modal noPadding open={visible} onClose={closeHandler}>
          ...
          css={{display:'block'}}
          >
            <div className="flex items-center w-full justify-between gap-20 p-[15px] border-b-2 border-gray-200">
              <p className="font-bold text-2xl">Get the TikTik app</p>
              <p>x</p>
            </div>
            <div className="flex justify-center font-semibold text-xl py-[20px]">Scan QR code to download TikTik</div>
          </Modal.Header>
          <Modal.Body>
            <Image
              showSkeleton
