...
const ProfilePopup = ({show}) => {
    ...
    return (
        <div 
        className={`${show&&'hident_'} ease-in-out duration-1000 opacity-0 z-50 flex flex-col absolute w-[220px]  bg-white rounded-[12px] border-gray-200 top-[50px] right-0 shadow-gray-400  shadow-md overflow-hidden`}
