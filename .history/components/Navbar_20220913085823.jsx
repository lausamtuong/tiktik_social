          ...
          <div className="">
            ...
            /> */}
             <button
                        ...
                        className='bg-white text-lg text-[#F51997] border-[1px] border-[#F51997] font-semibold px-6 py-2 rounded-md outline-none w-full  hover:text-white hover:bg-[#F51997]'
                        >
                            Log In
                        </button>
          </div>
