...
const LikeButton: NextPage<IProps> = ({
 ...
 <Tooltip content={"Embed"} css={{fontWeight:'bold'}} css={{fontWeight}} rounded color="invert">
        <div className="bg-primary rounded-full p-2 md:p-3  hover:bg-gray-200 cursor-pointer text-[#161823] "
         ...
         <Tooltip content={"Developers love Next.js"} css={{fontWeight}} rounded color="invert">
