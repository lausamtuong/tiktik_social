    ...
    <div className="flex flex-col border-b-2 border-gray-200 pb-6 ">
      <div className="">
        <div className="flex gap-3 p-2 font-semibold rounded">
          <div className="md:w-[60px] md:h-[40px]  w-12 h-12">
            <Link href="/">
                ...
                <Grid>
                  <div className="cursor-pointer">
                    <Popover>
                      ...
                      <Popover.Content css={{ px: "$4" ,cursor:'pointer'}}>
                        <UserTwitterCard />
                      </Popover.Content>
                    </Popover>
                  </div>
      ...
      <div className="lg:ml-20 flex gap-4 relative">
        <Link href={`/details/${post._id}`}>
          <div
            ...
            className="overflow-hidden lg:w-[220px] h-[500px] lg:h-[260px] w-[300px] rounded-[7px] cursor-pointer bg-gray-100"
          >
            <Waypoint
              onEnter={() => {
                videoRef?.current?.play();
