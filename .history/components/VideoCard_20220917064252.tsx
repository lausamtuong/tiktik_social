     ...
     <CardInfo post={post}/>
      <div className="lg:ml-20 flex gap-4 relative pr-[20px]">
        ...
        <div className="flex flex-col justify-end gap-2">
          ...
          <div className="bg-gray-200 hover:bg-gray-300 cursor-pointer rounded-full w-[30px] h-[30px] p-[6px] md:w-[60px] md:h-[60px] flex items-center justify-center">
            <AiOutlineComment className="text-sm md:text-3xl" />
          </div>
          <div className="bg-gray-200 hover:bg-gray-300 cursor-pointer rounded-full w-[30px] h-[20px] p-[6px] md:w-[60px] md:h-[60px] flex items-center justify-center">
