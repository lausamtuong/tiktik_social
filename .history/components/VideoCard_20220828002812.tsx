      ...
      <div className="lg:ml-20 flex gap-4 relative">
        ...
        className="rounded-3xl">
          ...
          {isHover&&(
            ...
            cursor-poitiner left-8 md:left-14 lg:left-0 flex gap-10 
            lg:justify-around w-[100px] md:w-[50px] p-3 rounded">
              {isPlaying?(
                <button onClick={onVideoPress}>
                  <BsFillPauseFill className='text-white text-4xl lg:text-5xl'/>
                </button>
              ):(
                <button onClick={onVideoPress}>
                  <BsFillPlayFill className='text-white text-4xl lg:text-5xl'/>
                </button>
              )}
                {isMuted?(
                <button onClick={()=>setIsMuted(false)}>
                  <HiVolumeOff className='text-white text-4xl lg:text-5xl'/>
                </button>
              ):(
