...
const LikeButton: NextPage<IProps> = ({
 ...
 <Tooltip content={"Embed"} css={{fontWeight:'bold'}}  rounded color="invert">
        <div className="bg-primary rounded-full p-2 md:p-3  hover:bg-gray-200 cursor-pointer text-[#161823] "
         ...
         <Tooltip content={"Send to Friends"} css={{fontWeight:'bold'}} rounded color="invert">
        <div className="bg-primary rounded-full p-2 md:p-3  hover:bg-gray-200 cursor-pointer text-[#fe2c55] "
         ...
         <Tooltip content={"Share to Facebook"} css={{fontWeight:'bold'}} rounded color="invert">
        <div className="bg-primary rounded-full p-2 md:p-3   cursor-pointer hover:bg-gray-200 text-[#0075fa] ">
        <FacebookShareButton url={"https://nextui.org/docs/components/button#button"||window.location.href}>
          <BsFacebook className="text-lg md:text-xl" />

        </FacebookShareButton>
        </div>
        </Tooltip>
         <Tooltip content={"Share to Whatsapp"} css={{fontWeight:'bold'}} rounded color="invert">
        ...
        <div className="bg-primary rounded-full p-2 md:p-3  hover:bg-gray-200 cursor-pointer text-[#25d366] ">
         ...
         <Tooltip content={"Share to Twitter"} css={{fontWeight:'bold'}} rounded color="invert">
