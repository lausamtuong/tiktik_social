...
const Discorver = () => {
  const activeTopic ="xl:border-2 xl:border-ray-300 hover:bg-primary px-3 py-2 rounded xl:rounded-full flex items-center gap-2 justify-center cursor-pointer text-[#F51997]"
