    ...
    return (
        ...
        opacity-0 z-50 flex flex-col absolute w-[220px] 
         bg-white rounded-[12px] border-gray-200 top-[50px] right-0
          ...
          before:content-[''] before:h-[70px] before:mt-[-3rem] before:w-[40px] before:cursor-pointer before:absolute before:bg-red-500 before:top-0 before:right-0 before:rounded-full
          `}
