      ...
      className={`hover:hidden_ ease-in-out duration-1000 
        opacity-0 z-50 flex flex-col absolute w-[220px] 
         bg-white rounded-[12px] border-gray-200 top-[50px] right-0
          ...
          before:content-[''] before:h-[70px] before:mt-[-3rem] before:w-[200px] before:bg-red-400 before:cursor-pointer before:absolute  before:top-0 before:right-0 before:rounded-full
          `}
    >
      <div className="py-[10px] rounded-[12px] hover:bg-gray-100 cursor-pointer overflow-hidden w-full py-2 flex pl-[20px] items-center gap-6">
