    ...
    <div className="flex sm:justify-between gap-[100px] items-center sm:gap-0">
      <div className={`${flex} gap-6`}>
        <div className="mt-4 flex gap-2 justify-center items-center   cursor-pointer">
          {alreadyLiked ? (
            <div
              className="bg-primary rounded-full hover:bg-gray-200 px-[ text-[#F51997] "
            ...
            <div
              className="bg-primary rounded-full hover:bg-gray-200 px-[ "
              onClick={handleLike}
            >
              <MdFavorite className="text-lg md:text-xl" />
            </div>
        ...
        <div className="mt-4 flex gap-2 justify-center items-center   cursor-pointer">
          <div
            className="bg-primary rounded-full hover:bg-gray-200 px-[ text-black "
            onClick={handleDislike}
          >
      ...
      <div className="flex gap-2 mt-4">
        ...
        >
          <div
            className="bg-primary rounded-full px-[  hover:bg-gray-200 cursor-pointer text-[#161823] "
            onClick={handleDislike}
          >
        ...
        >
          <div
            className="bg-primary rounded-full px-[  hover:bg-gray-200 cursor-pointer text-[#fe2c55] "
            onClick={handleDislike}
          >
        ...
        <Tooltip
          ...
          color="invert"
        >
          <div className="bg-primary rounded-full px-[   cursor-pointer hover:bg-gray-200 text-[#0075fa] ">
        ...
        <Tooltip
          ...
          color="invert"
        >
          <div className="bg-primary rounded-full px-[  hover:bg-gray-200 cursor-pointer text-[#25d366] ">
        ...
        <Tooltip
          ...
          color="invert"
        >
          <div className="bg-primary rounded-full px-[  hover:bg-gray-200 cursor-pointer text-[#1da1f2] ">
        ...
        <div className="bg-primary rounded-full px-[  hover:bg-gray-200 cursor-pointer  ">
