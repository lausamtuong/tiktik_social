        ...
        <div className='flex justify-center px-[30px] py-[10px]'>
          <div className="flex flex-col gap-3">
            ...
            <div className="">
              ...
              <p className='font-normal flex gap-1 items-center'>2. On Profile, tap <AiOutlineUserAdd className='font-xl'/> </p>
              <div className='font-normal flex gap-1 items-center'>3. Tap <AiOutlineScan/> and scan the QR code to confirm your login</div>
            </div>
          </div>
            <div className="
            ">
