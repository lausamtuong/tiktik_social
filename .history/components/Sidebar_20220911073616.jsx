...
const Sidebar = () => {
  ...
  const normalLink =
    "flex items-center gap-3 hover:bg-primary p-3 justify-center xl:justify-start cursor-pointer font-semibold text-[#F51997] text-black rounded ";
  return (
    <div className=''>
      <div
          ...
          <div className="xl:border-b-2 border-gray-200 xl:pb-4">
            <Link href="/">
              <div className={normalLink}>
                ...
                <span className="hidden text-2xl xl:block"> For You</span>
              </div>
            </Link>
            <Link href="/">
              <div className={normalLink}>
                ...
                <span className="hidden text-2xl xl:block"> Following</span>
              </div>
            </Link>
            <Link href="/">
              <div className={normalLink}>
                ...
                <span className="hidden text-2xl xl:block"> Live</span>
              </div>
            </Link>
          </div>
          {!userProfile && (
