...
const Sidebar = () => {
  ...
  return (
    <div className=''>
      ...
      {showSidebar && (
        <div className=" scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-100 flex flex-col justify-start xl:w-400 w-20 mb-10 border-r-2 border-gray-100 xl:border-0 p-3">
