...
import { AiOutlineLogout,AiOutlineQrcode } from "react-icons/ai";
      ...
      <div className="">
        ...
        >
          ...
          >
            ...
            <div className="flex items-center w-full justify-center  pb-[20px] border-b-2 border-gray-200">
          ...
          <GoogleLogin
              ...
              />
          <div className="border-[1px] items-center  border-gray-200 p-[10px] w-[70px] h-[40px] flex">
              <AiOutlineQrcode className='font-bold'/>
              <div className="flex flex-1 justify-center font-bold">Use QR code</div>
          </div>
