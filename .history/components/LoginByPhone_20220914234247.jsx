  ...
  return (
    <div className="flex flex-col justify-center px-[30px] py-[10px] gap-2">
      ...
      <div className="flex rounded-[4px] border  border-gray-200 bg-gray-100   gap-4">
        <div onClick={()=>setClick((prev)=>!prev)} className="cursor-pointer h-[44px] relative pr-[20px]">
          <div  className="flex items-center gap-4 after:content-[''] after:w-[1px] after:h-[30px] a= after:absolute after:right-0 after:bg-gray-300">
            <p>123</p>
