...
const ProfilePopup = () => {
    ...
    return (
        <div className=`${}hidden hover:block z-50 flex flex-col absolute w-[220px] 
         bg-white rounded-[12px] border-gray-200 top-[50px] right-0shadow-gray-400  shadow-md overflow-hidden`
          onMouseLeave={}
          >
