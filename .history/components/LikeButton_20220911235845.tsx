  ...
  return (
    <div className="flex justify-between items-center">
      ...
      <div className="flex gap-2 mt-4">
        <div
          className="bg-primary rounded-full p-2 md:p-3 text-[#1da1f2] "
          onClick={handleDislike}
        >
          <AiFillTwitterCircle className="text-lg md:text-2xl" />
        </div>
        <div
          className="bg-primary rounded-full p-2 md:p-3 text-[#161823] "
          onClick={handleDislike}
        >
          <ImEmbed2 className="text-lg md:text-xl" />
        </div>
        <div
          className="bg-primary rounded-full p-2 md:p-3 text-[#fe2c55] "
          onClick={handleDislike}
        >
          <FiSend className="text-lg md:text-xl" />
        </div>
        <div
          className="bg-primary rounded-full p-2 md:p-3 text-[#25d366] "
          onClick={handleDislike}
        >
          <BsWhatsapp className="text-lg md:text-xl" />
        </div>
        <div
          className="bg-primary rounded-full p-2 md:p-3 text-[#0075fa] "
          onClick={handleDislike}
        >
