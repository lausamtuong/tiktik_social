        ...
        >
          ...
          >
            <div className="flex justify-between p-[20px]">
              {showQR?(<IoIosArrowBack onClick={()=>{setShowQR(false)}} className='text-3xl'/>):''}
          ...
          <Modal.Body className=''>
           ...
           <> 
              ...
              <div className="border-[1px] items-center  border-gray-200 p-[10px] w-[400px] h-[40px] flex" onClick={()=>setShowp(true)}>
