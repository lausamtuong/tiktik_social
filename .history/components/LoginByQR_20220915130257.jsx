  ...
  return (
    <div className="flex justify-center px-[30px] py-[10px]">
      ...
      >
        ...
        <ProgressiveImage delay={3000} src="https://lf16-tiktok-web.ttwstatic.com/obj/tiktok-web/tiktok/webapp/main/webapp-desktop/b6d3cc69d3525571aef0.gif" placeholder="">
          {(src, loading) => {
