    ...
    return (
        ...
        <div className="flex gap-3 p-2 font-semibold rounded">
          ...
          <div className="flex  w-full sm:justify-between gap-[190px]  sm:gap-0">
            <div className="">
              <Link href="/">
                <div className="flex items-center gap-2">
                  <p className="hover:underline cursor-pointer underline-offset-1 flex gap-2 items-center text-lg md:text-xl font-bold text-primary">
            ...
            <div className="mr-[50px] flex flex-col items-center justify-start">
                <div>
          ...
          <p className='font-normal text-[14px]  text-gray-400'>12.3k</p>
            </div>
          </div>
        </div>
      </div>
