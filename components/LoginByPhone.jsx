  ...
  return (
    <div className="flex flex-col justify-center px-[30px] py-[10px] gap-2">
      <div className="flex justify-between items-center">
        ...
        <p className="font-normal text-[12px] hover:underline">Log in with email or username</p>
      </div>
      <div className="flex rounded-[4px] border  border-gray-200 bg-gray-100   gap-4">
        <div
          onClick={() => setClick((prev) => !prev)}
          className="cursor-pointer h-[44px] pl-[20px] relative pr-[20px]"
        >
      ...
      <div className="flex rounded-[4px] border  border-gray-200 bg-gray-100   gap-4">
        ...
        <button
          className={`bg-white py-[10px] px-[10px] font-semibold ${
            !phoneNumber ? "text-gray-300" : ""
          }`}
        >
          Send Code
        </button>
      ...
      <div className="">
        <p className="text-[12px] hover:underline">Log in with password</p>
      </div>
      <div className="">
        <Button color="error" disabled={(digitCode.length==6&&phoneNumber)?false:true} auto css={{width:'100%',marginTop:'20px',fontSize:'18px'}}>
            Log in
        </Button>
      </div>
    </div>
